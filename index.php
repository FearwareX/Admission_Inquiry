...
<form action="results.php" method="POST" role="form">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno1">
    </div>
    <div class="form-group">
        <label for="">第二志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno2">
    </div>
    <div class="form-group">
        <label for="">第三志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno3">
    </div>
    <div class="form-group">
        <label for="">第四志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno4">
    </div>
    <div class="form-group">
        <label for="">第五志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno5">
    </div>
    <div class="form-group">
        <label for="">第六志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno6">
    </div>
    <div class="form-group">
        <label for="">第七志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno7">
    </div>
    <div class="form-group">
        <label for="">第八志愿</label>
        <input type="text" class="form-control" placeholder="请输入志愿学校的院校代码" name="usno8">
    </div>
